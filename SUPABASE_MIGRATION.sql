-- MAT + GHL Integration Database Migration
...
-- 3. Add GHL columns to appointments table (if it exists)
DO $$ 
BEGIN
...
-- 4. Create revenue_tracking table if it doesn't exist
...
-- 9. Create RLS policies for revenue_tracking
...
-- 10. Create RLS policies for webhook_logs
