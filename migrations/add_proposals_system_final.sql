-- Migration: Add Proposals System to MAT (FINAL)
-- Description: Adds service_packages and proposals tables with Dream Client Profile integration
-- Uses UUID for ALL foreign keys to match MAT's actual schema
...
CREATE TABLE IF NOT EXISTS service_packages (
    ...
    -- Example: [{"name": "Weekly Social Posts", "description": "4 posts per month"}]
...
CREATE TABLE IF NOT EXISTS proposals (
    ...
    -- Relationships (ALL UUID to match MAT schema)
...
-- Add proposal_count to hot_leads
