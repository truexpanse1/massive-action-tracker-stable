-- Migration: Add Proposals System to MAT (FIXED)
-- Description: Adds service_packages and proposals tables with Dream Client Profile integration
-- Fixed to match MAT's existing schema (bigint IDs instead of UUID)
...
CREATE TABLE IF NOT EXISTS proposals (
    ...
    -- Relationships (using BIGINT to match MAT schema)
...
-- Insert pre-built service package templates (using dummy IDs that will be replaced)
